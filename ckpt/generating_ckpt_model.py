...
with tf.Session() as sess:
    ...
    # output_graph_def = graph_util.convert_variables_to_constants(sess, sess.graph_def, ['op_to_store'])
    # model_f = tf.gfile.FastGFile("tensorflow_pb/model/age.pb", mode="wb")
